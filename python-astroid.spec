...
%global t_requires python-enum34 python-six python-wrapt python-lazy-object-proxy python-singledispatch python2-backports-functools_lru_cache
...
%if 0%{?with_python3}
%package -n python%{python3_pkgversion}-astroid
Summary:        %{sum}
Group:          Development/Languages
...
%description -n python%{python3_pkgversion}-astroid
%{desc}
...
%if 0%{?with_python3}
%files -n python%{python3_pkgversion}-astroid
%doc README.rst
%license COPYING
