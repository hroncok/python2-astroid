...
Version:        1.6.4
%global github_tag   %{github_name}-%{version}
Release:        1%{?dist}
Summary:        Common base representation of python source code for pylint and other projects
License:        GPLv2+
URL:            https://github.com/%{github_owner}/%{github_name}
Source0:        https://github.com/%{github_owner}/%{github_name}/archive/%{github_tag}/%{github_name}-%{version}.tar.gz

# Requirements for tests (BuildRequires) and run (Requires)
%global t_requires python2-enum34 python2-six python2-wrapt python2-lazy-object-proxy python2-singledispatch python2-backports-functools_lru_cache
...
%prep
%autosetup -n %{github_name}-%{github_tag} -p1
...
%changelog
* Wed May 16 2018 Miro Hrončok <mhroncok@redhat.com> - 1.6.4-1
- Update to 1.6.4
- Split from python-astroid into python2-astroid to allow python3-astroid 2.x
